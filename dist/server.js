            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        oldDate = historicalData[historicalData.length - 1].date;
                        console.log(oldDate);
